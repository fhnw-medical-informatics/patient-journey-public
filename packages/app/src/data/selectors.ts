...
import { Patient, PatientDataColumnType, PatientId, PatientIdNone } from './patients'
...
export const selectPatientDataRows = createSelector(selectPatientData, (patientData) => patientData.allEntities)
...
const selectFocusEntityType = (_: RootState, type: FocusEntity['type']) => type
...
export const selectPatientDataColumns = createSelector(selectPatientData, (patientData) => patientData.columns)
...
const selectPatientDataColumnType = (_: RootState, columnType: PatientDataColumnType) => columnType
...
const selectEventDataColumnType = (_: RootState, columnType: EventDataColumnType) => columnType

// TODO: Although it doesn't seem to be an issue right now, this selectors memoization
